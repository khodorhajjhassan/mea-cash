...
<div class="mx-auto flex min-h-screen max-w-md items-center px-4">
    <section class="panel w-full">
        ...
        <p class="mt-1 text-sm text-slate-500">Frontend user dashboard will be implemented next.</p>
        ...
        <a href="{{ route('admin.login') }}" class="mt-4 inline-flex text-sm text-sky-700 underline">Admin login</a>
    </section>
</div>
</body>
</html>
