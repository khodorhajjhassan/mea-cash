...
<div id="sf-modal-backdrop" class="fixed inset-0 z-[100] hidden items-center justify-center overflow-hidden bg-background/85 p-3 backdrop-blur-xl" role="dialog" aria-modal="true">
    ...
    <div id="sf-modal-card" class="relative flex max-h-[92vh] min-h-0 w-full max-w-[900px] flex-col overflow-hidden rounded-[24px] border border-outline-variant/15 bg-surface-container/90 shadow-[0_26px_100px_rgba(0,0,0,0.72)] backdrop-blur-2xl md:max-h-[86vh] md:min-h-[460px] md:flex-row md:rounded-[28px]">
